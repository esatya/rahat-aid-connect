								...
								<div className="form-group basic">
									<div className="input-wrapper">
										...
										<Form.Control
											...
											value={beneficiaryDetail.education ? beneficiaryDetail.education : ''}
											onChange={updateBeneficiaryData}
										/>
										<i className="clear-input">
											<IoCloseCircle className="ion-icon" />
								...
								<div className="form-group basic">
									<div className="input-wrapper">
										...
										<Form.Control
											...
											value={beneficiaryDetail.profession ? beneficiaryDetail.profession : ''}
											onChange={updateBeneficiaryData}
										/>
										<i className="clear-input">
											<IoCloseCircle className="ion-icon" />
								...
								<div className="form-group basic">
									<div className="input-wrapper">
										...
										<Form.Control
											...
											value={
												beneficiaryDetail.family_members ? beneficiaryDetail.family_members : ''
											}
											onChange={updateBeneficiaryData}
										/>
										<i className="clear-input">
